"""
ClimbFit 训练计划版网页（三页切换 · 复古低饱和配色）
========================================
只保留 1 个核心互动功能：今日训练计划，做成"页面切换模式"：
...
st.markdown(
    ...
    f'Progressive overload: warm up first, then train, then challenge yourself.</p>',
    unsafe_allow_html=True,
)
...
# 核心修改：调用封装好的三阶段计划，自带route/target/tip结构
